    ...
    <div id="Contact">
      <section className="text-gray-600 body-font relative">
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative hover:bg-white border-red-700 hover:border-4">
            <iframe
              width="100%"
              height="100%"
            ...
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
              ...
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <p className="leading-relaxed">+92-310-2939848</p>
              </div>
            </div>
          </div>
            ...
            <form action="https://formspree.io/f/xyzgdylr" method="POST">
              ...
              <div className="relative mb-4">
                ...
                <textarea
                  id="message"
                  name="message"
                  className="w-full bg-white rounded border border-gray-300 focus:border-red-700 focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                  defaultValue={""}
                  required
                />
              </div>
              <button className="text-white bg-gray-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-700 rounded text-lg">
                Send Email
              </button>
            </form>
